...
#测试ecapa方法
def voice2id_pyannote2_final_ecape(save_path,a):
    # 视频文件路径
    ...
    np.savetxt(save_path+'final_segments_ecapa_final_study11_segments.txt',segments_final,fmt='%d')
    #np.savetxt(save_path+'segments.txt',segments,)
    np.savetxt(save_path+'id_segments_ecapa_final_study11.txt',id_final,fmt='%d')
